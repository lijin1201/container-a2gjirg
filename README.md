...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a2gjirg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a2gjirg.containers.anotherwebservice.com/
...
```
git clone git@github.com:lijin1201/container-a2gjirg.git
cd container-a2gjirg
```
...
```
docker attach container-a2gjirg
```
